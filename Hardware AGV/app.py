...
# Thread function to count the position of the AGV
def count_position_thread():
    while True:
        position_object.count_position(motor_object.status)
        time.sleep(0.01)
...
if __name__ == "__main__":
    ...
    # position_thread = threading.Thread(target=count_position_thread)
